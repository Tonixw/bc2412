...
public class DemoLinkedList {
  public static void main(String[] args) {
    ...
    // LinkedList advantages: add/remove haed/tail
    // Array/ArrayLista advantages: Point the object directly if you know the position
    // Person.class (name)
    ...
    // During runtime, we found the object is LinkedList, the add() method will be the LinkedList on 
