public class DemoDataType {
  public static void main(String[] args) {
    ...
    char c3 = '!';
    char c4 = ' '; // space
    // cgar c5 = ''; // ! at least one character
    ...
    char q = 'a';
    int u = q; // cahr value can be assigned to int???
    ...
    char A3 = 'A';
    int p2 = A3;
    System.out.println(p2); //65

    char A4 = 'a';
    int p3= A4;
    System.out.println(p3); //97
